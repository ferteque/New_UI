  ...
  import {editCredentials} from './script.js';
...
["copyButtonDriveDownloadLink", "copyButtonEPG", "copyButtonEPGDrive"].forEach(id => {
  ...
  document.getElementById('editCredsForm').addEventListener('submit', function(event) {
    event.preventDefault();
    document.getElementById("editCredsForm").style.display = "none";
    document.getElementById("spinner5").style.display = "block";
    document.getElementById('Wait5').style.display='block';
    const form = event.target;
    const formData = new FormData(form);
...
export function closeCategoriesModal() {
  ...
  const modalEditCreds = document.getElementById("editCreds");
  const openEditCreds = document.getElementById("openEditCreds");
  ...
  openEditCreds.onclick = () => {
      document.getElementById("editCredsForm").style.display = "block";
      modalEditCreds.style.display = "block";
    };

    closeEditCreds.onclick = () => {
      document.getElementById("spinner5").style.display = "none";
      document.getElementById('Wait5').style.display='none';
      modalEditCreds.style.display = "none";
    };
